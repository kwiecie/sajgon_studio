...
const imageClasses =
  "rounded-4xl w-full max-w-[360px] h-auto shadow-lg shadow-[#484293] hover:shadow-2xl hover:shadow-[#484293] hover:brightness-110 transition-shadow duration-300 cursor-pointer";
